# Generated by Django 2.1.5 on 2021-03-10 13:44
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='SalesReturn',
            fields=[
                ('SalesReturnId', models.AutoField(primary_key=True, serialize=False)),
                ...
                ('GST', models.CharField(max_length=100)),
                ('SubTotal', models.CharField(max_length=100)),
                ('InvoiceNo', models.ForeignKey(db_column='InvoiceNo', on_delete=django.db.models.deletion.CASCADE, to='InventoryApp.SalesOrdersOffline')),
            ],
        ),
        migrations.CreateModel(
            name='SalesReturnDetail',
            fields=[
                ('SalesReturnDetailId', models.AutoField(primary_key=True, serialize=False)),
                ('Quantity', models.CharField(max_length=10)),
                ('SalePrice', models.CharField(max_length=10)),
                ('Amount', models.CharField(max_length=10)),
                ('GST', models.CharField(max_length=100)),
                ('ProductId', models.ForeignKey(db_column='ProductId', on_delete=django.db.models.deletion.CASCADE, to='InventoryApp.Product')),
                ('SalesReturnId', models.ForeignKey(db_column='SalesReturnId', on_delete=django.db.models.deletion.CASCADE, to='InventoryApp.SalesReturn')),
            ],
        ),
        migrations.CreateModel(
