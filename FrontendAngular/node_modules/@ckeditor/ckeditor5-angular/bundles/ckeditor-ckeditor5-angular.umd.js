(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(require('@angular/core'),require('@angular/forms'),require('@angular/common'),exports, require('@ckeditor/ckeditor5-watchdog/src/editorwatchdog'), require('@angular/core'), require('@angular/common'), require('@angular/forms')) :
    typeof define === 'function' && define.amd ? define('@ckeditor/ckeditor5-angular', ['@angular/core','@angular/forms','@angular/common','exports', '@ckeditor/ckeditor5-watchdog/src/editorwatchdog', '@angular/core', '@angular/common', '@angular/forms'], factory) :
    (factory(global.ng.core,global.ng.forms,global.ng.common,(global.ckeditor = global.ckeditor || {}, global.ckeditor['ckeditor5-angular'] = {}),global.EditorWatchdog,global.ng.core,global.ng.common,global.ng.forms));
}(this, (function (ɵngcc0,ɵngcc1,ɵngcc2,exports,EditorWatchdog,core,common,forms) { 
